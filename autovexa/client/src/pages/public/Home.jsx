  ...
  return (
    <div className="animate-fade-up">
      ...
      <section className="relative min-h-[500px] md:min-h-[560px] flex items-center overflow-hidden">
        ...
        <div className="relative page-container py-12 md:py-20 w-full">
          <div className="max-w-2xl">
            ...
            <p className="text-base md:text-lg text-slate-300 mb-7 max-w-xl leading-relaxed">
          ...
          <div className="glass-panel rounded-2xl p-3 sm:p-4 shadow-2xl shadow-black/30 max-w-2xl">
      ...
      <section className="bg-slate-950 text-white">
        <div className="page-container py-8 grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-8 text-center">
          {[
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-5 gap-3 md:gap-4">
            {BRANDS.map((b) => (
              <Link
                ...
                className="group flex items-center justify-center bg-slate-50 hover:bg-slate-950 rounded-xl py-4 px-3 text-center font-semibold text-slate-700 hover:text-white transition-all duration-300 border border-slate-100 hover:border-slate-900 hover:shadow-lg"
              >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
          {[
            ...
            },
            {
              ...
              <div key={item.title} className="card-static p-5 hover:shadow-lg transition-shadow duration-300 group">
              <div
      ...
      {/* ── How It Works ──────────────────────────────────── */}
      <section className="hero-mesh text-white py-14 md:py-16">
