...
Booking.init(
  {
    ...
    paymentMethod: { type: DataTypes.STRING(40), defaultValue: '' },
    transactionId: { type: DataTypes.STRING(80), defaultValue: '' },
    razorpayOrderId: { type: DataTypes.STRING(80), defaultValue: '' },
    razorpayPaymentId: { type: DataTypes.STRING(80), defaultValue: '' },
    razorpaySignature: { type: DataTypes.STRING(128), defaultValue: '' },
    razorpayTransferId: { type: DataTypes.STRING(80), defaultValue: '' },
    feedbackRating: { type: DataTypes.INTEGER, allowNull: true },
    feedbackComment: { type: DataTypes.TEXT, defaultValue: '' },
